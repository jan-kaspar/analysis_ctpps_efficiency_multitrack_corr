...
pen q_pens[];
quantities.push("h_suff_tr_no OVER h_suff"); q_labels.push("N(suff \& !left tr \& !right tr) / N(suff)"); q_pens.push(black);
quantities.push("h_suff_tr_L OVER h_suff"); q_labels.push("N(suff \& left tr \& !right tr) / N(suff)"); q_pens.push(red);
quantities.push("h_suff_tr_R OVER h_suff"); q_labels.push("N(suff \& !left tr \& right tr) / N(suff)"); q_pens.push(blue);
quantities.push("h_suff_tr_LR OVER h_suff"); q_labels.push("N(suff \& left tr \& right tr) / N(suff)"); q_pens.push(heavygreen);
